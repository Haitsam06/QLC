...
export default function TeacherJadwal() {
    /* ── Auth: ambil _id dari user MongoDB lewat Inertia props ── */
    ...
    /* ── Ownership: guru hanya bisa edit agenda miliknya sendiri ── */
    const canEdit = (a: Agenda) =>
        myUserId !== null && a.user_id !== null && a.user_id === myUserId;

    /* ── CRUD handlers ── */
    const handleAdd = async (f: FormState) => {
        // user_id TIDAK dikirim — diambil dari auth()->id() di controller
