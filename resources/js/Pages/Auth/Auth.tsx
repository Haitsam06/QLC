...
import { BookOpen, User, Lock, Eye, EyeOff, Mail, ArrowRight, ShieldCheck, AlertCircle, Phone, MapPin, ArrowLeft } from 'lucide-react';
                    ...
                    <div key={`brand-text-${activeTab}`} className="relative z-10 max-w-lg px-12 text-center flex flex-col items-center anim-fade">
                        ...
                        <p className="text-green-100 text-lg leading-relaxed h-20">
                            {activeTab === 'login'
                                ...
                                : 'Mulai perjalanan pendidikan buah hati Anda dengan bergabung ke dalam sistem informasi institusi QLC.'}
                        </p>
                    ...
                    <div className="w-full max-w-md mx-auto">
                        ...
                        <div className="flex bg-gray-200/60 p-1.5 rounded-2xl mb-10 shadow-inner">
                            ...
                            <button
                                ...
                                className={`flex-1 text-center py-2.5 rounded-xl text-sm font-bold transition-all ${activeTab === 'login' ? 'bg-white text-green-700 shadow-sm' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-200/50'}`}
                            >
                                Masuk
                            </button>
                        </div>
                        ...
                        <div key={`content-${activeTab}`} className="anim-fade">
                            <div className="mb-8">
                                <h2 className="text-3xl font-extrabold text-gray-900 mb-2">{activeTab === 'login' ? 'Selamat Datang Kembali' : 'Buat Akun Baru'}</h2>
                                <p className="text-gray-500 text-sm font-medium">
                                    {activeTab === 'login' ? 'Silakan masuk menggunakan kredensial akun QLC Anda.' : 'Lengkapi data di bawah ini untuk mendaftarkan akun.'}
                                </p>
                            </div>
                            ...
                            {activeTab === 'login' ? (
                                ...
                                <form onSubmit={handleLoginSubmit} className="space-y-5">
                                    <div>
                                        ...
                                        <div
                                            className={`relative flex bg-white border rounded-xl overflow-hidden transition-all ${loginForm.errors.username ? 'border-red-400 ring-2 ring-red-100' : 'border-gray-200 focus-within:border-green-500 focus-within:ring-2 focus-within:ring-green-100'}`}
                                        >
                                    ...
                                    <div>
                                        ...
                                        <div
                                            className={`relative flex bg-white border rounded-xl overflow-hidden transition-all ${loginForm.errors.password ? 'border-red-400 ring-2 ring-red-100' : 'border-gray-200 focus-within:border-green-500 focus-within:ring-2 focus-within:ring-green-100'}`}
                                        >
                                            <div className="flex items-center pl-4 text-gray-400 flex-shrink-0">
                                                <Lock size={16} />
                                            </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input
                                                type="checkbox"
                                                checked={loginForm.data.remember as boolean}
                                ...
                                <form onSubmit={handleRegisterSubmit} className="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div
                                            className={`relative flex bg-white border rounded-xl overflow-hidden transition-all ${registerForm.errors.address ? 'border-red-400 ring-2 ring-red-100' : 'border-gray-200 focus-within:border-green-500 focus-within:ring-2 focus-within:ring-green-100'}`}
                                        >
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold text-gray-700 uppercase tracking-wide mb-2">
                                                Email <span className="font-normal text-gray-400 capitalize">(Opsional)</span>
                                            </label>
                                            <div
