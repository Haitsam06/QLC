            ...
            <div className="w-full max-w-[560px] max-h-[90vh] flex flex-col bg-white border border-slate-200 rounded-[28px] shadow-2xl animate-[slideUp_0.3s_ease-out]">
                ...
                <div className="px-7 py-6 flex flex-col gap-5 overflow-y-auto flex-1">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input
                            type="date"
                            className={`h-12 px-4 bg-slate-50 border rounded-2xl text-sm font-bold focus:bg-white focus:ring-4 transition-all outline-none ${e.tanggal_lahir ? 'border-red-500 focus:ring-red-500/10' : 'border-transparent focus:border-[#1B6B3A] focus:ring-[#1B6B3A]/10'}`}
