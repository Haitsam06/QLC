                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-y-20 md:gap-x-8 md:gap-y-8">
                        {leaders.map((dewan, idx) => (
                            <div
                                key={idx}
                                className={`reveal opacity-0 translate-y-8 bg-white/10 border border-white/10 rounded-[2.5rem] p-8 pt-20 relative flex flex-col hover:-translate-y-3 transition-all duration-300 group hover:shadow-xl hover:border-white/30 animate-in fade-in slide-in-from-bottom-10`}
                    ...
                    <div className="mt-20 text-center reveal opacity-0 translate-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000" style={{ transitionDelay: '0.5s' }}>
                        <button onClick={() => router.get('/pengurus')} className="bg-white text-[#1B6B3A] hover:bg-gray-100 hover:scale-105 border-2 border-white px-9 py-4 rounded-full font-bold text-lg transition-all duration-300 shadow-xl flex items-center gap-2 mx-auto">
            ...
            <section id="pilar" className="py-24 bg-gradient-to-b from-[#f0f7f6] to-[#ffffff]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16 reveal opacity-0 translate-y-8">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Pilar Inti Realisasi Konsep</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 justify-center">
                        {foundations.map((pilar, idx) => (
                            <div key={idx} className={`reveal opacity-0 translate-y-8 bg-white border border-gray-100 hover:shadow-xl transition-all duration-300 rounded-[2.5rem] p-8 flex flex-col`} style={{ transitionDelay: `${idx * 0.1}s` }}>
                                ...
                                <p className="text-base text-gray-600 leading-relaxed flex-1">{pilar.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                        {programs.map((prog, idx) => (
                            <div key={idx} className={`reveal opacity-0 translate-y-8 bg-white border border-gray-200/60 shadow-md hover:shadow-2xl transition-all duration-300 rounded-[2.5rem] overflow-hidden flex flex-col group`} style={{ transitionDelay: `${idx * 0.1}s` }}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 auto-rows-[250px] gap-4 md:gap-6">
                        {galleries.slice(0, 4).map((gal, idx) => (
                            <div
                                key={idx}
                                className={`reveal opacity-0 translate-y-8 ${idx === 0 ? 'md:col-span-2 md:row-span-2' : idx === 2 ? 'md:col-span-1 md:row-span-2' : 'md:col-span-1 md:row-span-1'} group relative overflow-hidden rounded-[2rem] shadow-sm cursor-pointer border border-white/50 bg-gray-100`}
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-[#1B6B3A]/90 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-6">
                                    <h3 className="text-white font-bold text-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">{gal.title}</h3>
                                </div>
                            </div>
                        ))}
                    </div>
